...
const EditPuzzle = () => {
    ...
    // ({
    //     name: singlePuzzle.name,
    //     description: singlePuzzle.description,
    //     stockQuantity: singlePuzzle.stockQuantity,
    //     imgURL: singlePuzzle.imgURL,
    //     puzzlePieces: singlePuzzle.puzzlePieces,
    //     price: singlePuzzle.price,
    //     stripeId: singlePuzzle.stripeId
    // }) = singlePuzzle;
